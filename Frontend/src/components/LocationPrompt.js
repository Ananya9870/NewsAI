  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
      <div className="bg-[#2a2d37] rounded-lg shadow-lg p-6 max-w-md w-full">
        ...
        <div className="mb-4">
          <h3 className="text-white font-semibold mb-2">Or enter your postal/zip code:</h3>
          <form onSubmit={handlePincodeSubmit} className="flex gap-2">
            <input
              ...
              className="flex-1 p-2 bg-[#343541] text-white rounded-md focus:outline-none focus:ring-1 focus:ring-[#3b82f6]"
            />
            <button
              type="submit"
